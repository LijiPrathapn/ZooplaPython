...
class SearchPage:
    ...
    highest_price="//select[@id='sort-order-dropdown']"
    ...
    def clickLocation(self,location):
        self.driver.find_element_by_xpath(self.location_textbox_xpath).send_keys(location)

    def clickSearch(self):
        self.driver.find_element_by_xpath(self.search_box).click()

    def sortHighestprice(self):
        self.driver.find_element_by_xpath(self.highest_price).send_keys("Highest price")
